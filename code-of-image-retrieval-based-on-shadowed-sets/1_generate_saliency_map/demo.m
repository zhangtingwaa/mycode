...
%%----------------------generate superpixels--------------------%%
    ...
    system(comm);   %Segmenting image ÓÃSLICÈí¼þ
...
% learn the optimal affinity matrix (eq. 3 in paper)
    dd = sum(W); D = sparse(1:spnum,1:spnum,dd); 
    clear dd;
